...
#元老院議員名（特に意味はないですが、スタッフクレジットに載ります。）
@genrou_name = ('ホワック','雨宮慈雨');

#副管理人名（特にadmin2とも関係ないですが、スタッフクレジットに載ります。）
@fukukanrinin_name = ('⑨－Leo氷凍','蟋蟀');

#臨時副管理人名（副管もそーだけどさー、選挙のたびに変えてね、ちゃんとｗ）
$rinjiadmin = '22';

#管理者パスワード
$admin_pass = 'QaZ2913078';

#お知らせバー　byまつぷら 2008/03/25　さらに改造2009/02/07
$news_bar1 =<< "EOM";
<marquee bgcolor=black><font color=red size=4><B>【選挙】</font><font color=white size=4>１０月期選挙の結果、副管理人に⑨－Leo氷凍氏・蟋蟀氏、臨時副管理人に22氏が当選致しました。</font></marquee>
EOM
$news_bar2 =<< "EOM";
<marquee bgcolor=black><font color=red size=4><B>【ＰＲ】</font><font color=white size=4>帝都A-10にて口ト４購入受付中！まったりと参加よろしくお願いします（´∀｀ ）　b\y\＠\ゆ\う</font></marquee>
EOM
$news_bar3 =<< "EOM";
<marquee bgcolor=black><font color=red size=4><B>【更新】</font><font color=white size=4>PlaintextタグとScriptタグの掲示板での使用を禁止しました。一部の外部から\貼\り\つ\け\る\形式のブログパーツ等に不具合が発生するかもしれません。</font></marquee>
EOM
$news_bar4 =<< "EOM";
<marquee bgcolor=black><font color=red size=4><B>【注意】</font><font color=white size=4>管理人の諸般の事情により、管理巡回が不定期になりがちです。ご要望等ございましたら、副管理人⑨－Leo氷凍氏・蟋蟀氏　ならびに　臨時副管理人22氏までどうぞ。</font></marquee>
EOM
...
#メンテナンス時のメッセージ
$mente_message = '臨時メンテナンス中！夜が明けるまで無理かもです。。。';

#画像フォルダー（img）の指定。プログラムからの相対パス or http://～から始まる絶対パス　※最後の「/」は不要です。
$img_dir = './img';

#戻り先ホームページ
$homepage = 'http://g10.daiwa-hotcom.com/';

#管理者メールアドレス（問い合わせ用）
$master_ad = 'TOWN総合外部板';

#管理者リンク#koko2005/09/08
$master_kb = 'http://snow.advenbbs.net/bbs/hira.htm';
...
#複雑怪奇注意。ボタンまわり。
$botanmawari = <<"EOM";
<td  class="thenaka"><img src="$img_dir/rl.gif" alt="利用規約"></td></tr><tr><td  class="thenaka" background="$img_dir/townnameback.gif"><INPUT type="button" value="新進グダニスク帝国憲法" onclick="parent.location='nkeppo.html';" style="color:#FFFFFF;background:#FF3300;border:1px dotted #000000;">：大切な約束ですので必ず目を通して下さい。</td></tr>
<tr><td  class="thenaka"><img src="$img_dir/bc.gif" alt="掲示板・チャット"></td></tr><tr><td  class="thenaka" background="$img_dir/townnameback.gif"><INPUT type="button" value="総合外部掲示板" onclick="parent.location='http://snow.advenbbs.net/bbs/hira.htm';" style="color:#FFFFFF;background:#0000CD;border:1px dotted #000000;">：ＴＯＷＮに入れないバグ等はこちらで。<BR>
<INPUT type="button" value="新進グダニスク帝国公式チャット" onclick="parent.location='http://matsupla.chatx.whocares.jp/';" style="color:#FFFFFF;background:#009900;border:1px dotted #000000;">：入室は<img alt="" width="24" height="12" src="http://matsupla.chatx.whocares.jp/mcond/users.png" /> 人、ROMは<img alt="" width="24" height="12" src="http://matsupla.chatx.whocares.jp/mcond/roms.png" />人です。
<BR>
<INPUT type="button" value="帝国チャットまとめWiki" onclick="parent.location='http://www20.atwiki.jp/gdchat/';" style="color:#FFFFFF;background:#009900;border:1px dotted #000000;">：チャット内の用語の説明等をしております。
</td>
EOM
...
※登録後、名前の変更はできません。</font>
EOM

#更新履歴
$town_koushinrireki = <<"EOM";
11月4日　　\T\O\P\整\理。
11月4日　　ヒラリラー朝時代をたたえる金の記念碑を
建ててみました。色調変えただけなのにお気に入りｗ
11月3日　　掲示板でPlaintextとScriptタグを無効化
11月1日　　職業が学生になっているか食事制限10日前で
ログアウト時に警告文が出るようになりました。
10月31日　 メニューちょい改造。まだまだ改造続く。
10月2日　　選挙終了
9月22日　　じうんじうんランドカオス３割増し。一応これで完成。
9月21日　　憲法大幅改正　管理人名まつぷら→松雪に変更
9月19日　　帝チャ移転に伴う更新。
ブックマークされていた方は変更願います。
9月18日　　新都譲渡に伴う一部変更。
9月8日　　 じうんじうんランド仮設置。まだ「仮」ですが。
9月6日　　 帝チャWiki設置
8月29日　　プロキシ制限開始。
7月28日　　クロム⇔クロート間地下鉄開通
7月28日　　クロート専板開設。
7月25日　　港町クロート追加
7月16日　　職業１件追加
6月23日　　元老院議員交代お知らせ。
6月1日　　 壁紙を初夏に
5月31日　　さい銭の金額増加、１日最高を１００億に
5月4日　　 障害復旧。
12時間以上にわたりアクセス\不\能\な状態が続いておりました。
お詫び\申\し\上げます。原因はori_ie_log.cgiの暴\走\で\した。
4月2日　　 ↓の解除。　深夜２時の作業だったのはここだけの話。
4月1日　　 ご察しください。
3月12日　　署名により憲法改正
3月11日　　壁紙を「Spring」に
3月9日　　 公式チャットを新型へ変更
...
@town_hairetu = ("帝都ジューレスカ","臨海新都心ラヴァート","ヨゼック西","ゴベス湖","ミサイル軍事島","大寒村","眠らない都スベラガス","秘密都市ロンヴァエ","クロム市","ヨゼック東","ガス村","港町クロート","じうんじうんランド");

#街の地価（上で指定した街の地価。左から順に上と対応させる。単位は万円）
@town_tika_hairetu = ("10000","1800","500","200","0","10","1600","25000","1000","1000","100","2500","935");

#街の背景スタイル（上で指定した街の背景スタイル設定。左から順に上と対応させる。スタイルで画像指定可）
@page_back = ("background-image : url( img/syoca.png)","background-color:#ffffcc","background-image : url( img/yz.gif)","background-color:#00ffff","background-color:#336699","background-color:#00ccff","background-color:#000000","background-image : url( img/sora.gif)","background-color:#00ff00","background-color:#ffffcc","background-color:#669933","background-image : url( img/398665.png)","background-attachment:fixed;background-color:#ffffff;background-image:url( img/396532.jpg);background-position:right bottom;background-repeat:no-repeat;");
...
@admin_bbs_syurui =('みんなの広場。総合掲示板です。','疑問解決BBS。普段疑問に思っている事を聞いてしまおう。','オススメ情報BBS。あなたのお薦め教えてください。','批判、要望掲示板　なにか言いたいことがあったらここに書き込んでください','新職業募集掲示板（採用率はほぼ0）','帝都ジューレスカ専用掲示板','港町ラヴァート専用掲示板','ヨゼック西住民専用掲示板','選挙所『住民の皆様誰かに投票願います！』','眠らない都の眠らない掲示板','ゲームネタ関連ＢＢＳ','裁判所　あなたの一言でなにかが変わる！','クロム市ICOIセンター','ヨゼック東住民談話所','クロート町民パーク','ゆる～いじうんじうん掲示板');

#上記掲示板の画像（左から上と対応させる）
@admin_bbs_gazou =('bbs1.gif','bbs2.gif','bbs3.gif','bbs4.gif','bbs6.gif','bbs5.gif','bbs5.gif','bbs5.gif','bbs8.gif','aisatu.gif','bbs7.gif','chip1061.gif','chip1064.gif','bbs5.gif','bbs5.gif','bbs5.gif');
...
.tyuu {  font-size: 13px; color: #006699}	/*ステータス中見出し*/
...
.midasi {  font-size: 16px; font-weight: bold; text-align: center;color: red}	/*街の名前*/
...
.theue {  border: #666666; border-style: solid; border-top-width: 1px; border-right-width: 1px; border-bottom-width: 0px; border-left-width: 1px; background-color:#ffffff}
.thenaka {  border: #666666; border-style: solid; border-top-width: 0px; border-right-width: 1px; border-bottom-width: 0px; border-left-width: 1px; background-color:#ffffff}
.theshita {  border: #666666; border-style: solid; border-top-width: 0px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; background-color:#ffffff}
