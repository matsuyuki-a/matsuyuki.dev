      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
	   ...
	   <!-- <div align="center"><img src="$machi_gazou{"$title"}" alt="$title"></div>> -->
        ...
        <tr><td  class="theue"><img src="$img_dir/dat.gif" alt="データ"></td></tr><tr>
          <td  class="thenaka" background="$img_dir/townnameback.gif">
<span  onMouseOver='onMes5(\"登録されているユーザ数（国全体）\")' onMouseOut='onMes5(\"\")'>人口：$sankasyasuu人</span>　<span  onMouseOver='onMes5(\"住民のお店の平均１日売り上げ額（国全体）\")' onMouseOut='onMes5(\"\")'>経済力：$mt_keizai_hyouzi円</span>　<span  onMouseOver='onMes5(\"掲示板の平均１日書き込み数（国全体）\")' onMouseOut='onMes5(\"\")'>繁栄度：$mt_henei_hyouzi</span></td></tr><tr>
<td  class="thenaka"><img src="$img_dir/tod.gif" alt="今日は・・・。"></td></tr><tr><td  class="thenaka" background="$img_dir/townnameback.gif">
$top_nannichi</td></tr>
<tr>$botanmawari</tr>
<tr><td  class="thenaka"><img src="$img_dir/at.gif" alt="注意"></td></tr><tr><td  class="thenaka" background="$img_dir/townnameback.gif">$town_top_att</td></tr>
<tr><td  class="thenaka"><img src="$img_dir/hst.gif" alt="更新履歴"></td></tr><tr><td  class="theshita" background="$img_dir/townnameback.gif"><TEXTAREA cols="55" rows="5" style="background-color:white;color:black;">
$town_koushinrireki</TEXTAREA></td></tr><tr><td>$osirase
<!-- ver.1.30ここから --> 
EOM
#koko2006/11/29
